...
if __name__ == "__main__":
    ...
    def add_prefix_suffix(example):
        example[dataset_text_field] = f"Human: {example[dataset_text_field]} Assistant: "
        return example

    # Apply the transformation to the train and eval datasets
    train_dataset = train_dataset.map(add_prefix_suffix)
    eval_dataset = eval_dataset.map(add_prefix_suffix)
